...
public class HeadlinesLoader extends AsyncTask<Void, Void, ArrayList<Article>>
{
    ...
    HeadlinesLoader(MainActivity mainActivity)
    {
    ...
    protected ArrayList<Article> doInBackground(Void... voids)
    {
        ...
        String URL = "http://newsapi.org/v2/top-headlines?country=us&apiKey=" + BuildConfig.API_KEY;
    ...
    private String getOfficialDatafromURL(String URL)
    {
        ...
        {
            Log.e(TAG, "EXCEPTION | HeadlinesLoader: getOfficialDatafromURL: bp:", e);
            return sb.toString();
        }
        return sb.toString();
    }
    ...
    @Override
    protected void onPostExecute(ArrayList<Article> headlines)
    {
        Log.d(TAG, "onPostExecute: bp: Total Headlines: " + headlines.size());
        mainActivity.updateHeadlines(headlines);
